  ...
  _updateShadowScrollClassName: function() {
    this.debounce('update-class', function() {
      if (this.$.list__body.scrollTop > 0) {
        this.toggleClass('shadow-component', true, dom(this.root).querySelector('.list__header'));
      }
      else {
        this.toggleClass('shadow-component', false, dom(this.root).querySelector('.list__header'));
      }
    }, 50);
  },
