...
function runBaseTests() {
  px_inbox_1 = document.getElementById('px_inbox_1');

  suite('Base Automation Tests for px-inbox', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-inbox fixture is created', function() {
      assert.isTrue(document.getElementById('px_inbox_1') !== null);
    });
